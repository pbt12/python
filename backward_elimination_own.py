# -*- coding: utf-8 -*-
"""
Created on Fri Dec 25 07:42:31 2020
...
dataset = pd.read_csv('C:/pyWork/pyData/50_Startups.csv')
...
## btaining DV & IV from the dataset
...
#importing datasets  
data_set= pd.read_csv('C:/pyWork/pyData/50_Startups.csv') 
